# genpark-cross-platform-meeting-action-item-dispatcher-skill
...
> **GenPark AI Agent Skill** -- Cross-platform meeting action item extractor & workspace synchronizer (Product Hunt)
